...
export default class Draggable extends React.Component<DraggableProps, DraggableState> {
  ...
  areObjectsAndBoundsAreEqual (propsA: Object, propsB: Object) {
    if (propsA.bounds instanceof Object && propsB.bounds instanceof Object) {
      const boundsA = propsA.bounds;
      const boundsB = propsB.bounds;

      const isequal = 
        Object.keys(boundsA).length === Object.keys(boundsB).length
        && Object.keys(boundsA).every(k => boundsA[k] === boundsB[k]);
  ...
  componentWillReceiveProps(nextProps: Object) {
    if (nextProps.bounds !== this.props.bounds || (!this.areObjectsAndBoundsAreEqual(nextProps, this.props))) {
      // bounds changed
